        ...
        <div class="bg-gray-800 text-black/50">
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                            ...
                            <nav class="-mx-3 flex flex-1 justify-end">
                                ...
                                @else
                                    ...
                                    @if (Route::has('register'))
                                        <a
                                            href="{{ route('register') }}"
                                            class="rounded-md px-3 py-2 text-white ring-1 ring-transparent transition hover:white/70 focus:outline-none focus-visible:ring-[#FF2D20]"
                                        >
                                            Register
                                        </a>
                                    @endif
                    ...
                    <p class=" text-lg w-full text-center text-white font-bold">Lomeli Flores Jesus Isaac</p>
